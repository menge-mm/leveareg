  ...
  return (
    ...
    >
      <div className="relative w-full h-full text-sm">
        ...
        >
          <svg className="w-full" viewBox="0 0 22 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
...
function TestTube({ value }: { value: number }) {
  return (
    <svg width="119" height="324" viewBox="0 0 119 324" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
